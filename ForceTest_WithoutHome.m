...
data_n = 5;
repeats = 1;
testdist = 7; %mm That might be the distance which the linear rail moves forward and then backward
...
while 1
    ...
    Pos = (PositionSteps-stoppos)*0.000047625+0.27 ; %Convert position in steps to mm
