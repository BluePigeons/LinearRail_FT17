...
%forces and torques for axis are broadcast.
...
if testfail1 == 1
    ...
    device.set('maxspeed',vel);
    device.moverelative(testdist/steptomm);
...
fill([posarrayavef;flipud(posarrayavef)],[forcearrayavef-(forcearraystdf*2);flipud(forcearrayavef+(forcearraystdf*2))],[.9 .9 .9],'linestyle','none');
line(posarrayavef,forcearrayavef);
hold on
fill([posarrayaveb;flipud(posarrayaveb)],[forcearrayaveb-(forcearraystdb*2);flipud(forcearrayaveb+(forcearraystdb*2))],[.9 .9 .9],'linestyle','none');
line(posarrayaveb,forcearrayaveb);

%plot(posarrayavef,forcearrayavef);
%hold on
%plot(posarrayaveb,forcearrayaveb);
